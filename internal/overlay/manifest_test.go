...
// Distdir and distfiles-cache resolution, Manifest DIST parsing and cache
// prepopulation now live in internal/common/distfiles, shared by every caller
// that needs a distdir. Their tests moved with them to
